...
function createDeleteClientModalHTML(title) {
  ...
  const headerContainerElement = deleteClientModalElement.querySelector('.modal__container_header');
  ...
  const bodyContainerElement = deleteClientModalElement.querySelector('.modal__body > .modal__container');
  bodyContainerElement.innerHTML = `<p class="delete-text">Вы&nbsp;действительно хотите удалить данного клиента?</p>`;

  const footerContainerElement = deleteClientModalElement.querySelector('.modal__footer > .modal__container');
...
export function createDeleteClientModal(clientId, { onDelete = (e) => {}, onCancel = (e) => {} } = {}) {
  const deleteClientModalElement = createDeleteClientModalHTML('Удалить клиента');
  ...
  const confirmBtn = deleteClientModalElement.querySelector('.modal__delete-btn');

...
function createCreateClientModalHTML(title) {
  ...
  const footerContainerElement = createClientModalElement.querySelector('.modal__footer > .modal__container');
...
export function createCreateClientModal({ onCreate = (e) => {}, onCancel = (e) => {} } = {}) {
